...
> = {
  ...
  defaultPremium: InitializeInstructionDataArgs["defaultPremium"];
  defaultPayoff: InitializeInstructionDataArgs["defaultPayoff"];
  defaultDelayHours: InitializeInstructionDataArgs["defaultDelayHours"];
};
...
export function getInitializeInstruction<
  ...
  TProgramAddress extends Address = typeof GOVERNANCE_PROGRAM_ADDRESS,
>(
  input: InitializeInput<TAccountConfig, TAccountOwner, TAccountSystemProgram>,
  config?: { programAddress?: TProgramAddress },
): InitializeInstruction<
  TProgramAddress,
  TAccountConfig,
